...
@onready var shuffle_button: Button = $GameUI/MainPanel/MarginContainer/VBox/ShuffleButton
@onready var money_label: Label = $GameUI/MainPanel/MarginContainer/VBox/StatsPanel/MoneyLabel
@onready var draws_label: Label = $GameUI/MainPanel/MarginContainer/VBox/StatsPanel/DrawsLabel
@onready var combo_label: Label = $GameUI/MainPanel/MarginContainer/VBox/StatsPanel/ComboLabel
@onready var deck_label: Label = $GameUI/MainPanel/MarginContainer/VBox/StatsPanel/DeckLabel
@onready var result_label: Label = $GameUI/MainPanel/MarginContainer/VBox/ResultLabel
